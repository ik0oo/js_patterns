 ...
 * которые дополняют основной функционал (декораторы).
 * А фишка в том, что декораторов может быть сколько угодно,
 * совмещаться они могут в произвольном порядке и (поскольку требуют от компонента только интерфейса)
 * — могут работать с разными компонентами.
 *
