 ...
 *
 * ‘абрика может проводить какую-то первичную инициализацию объектов
 *
 * Ќапример, предположим, у нас есть объекты Daddy, Mammy, и lad,
 * создава€ их с помощью фабрики мы можем просто сказать Чfamilyfactory.createLad(); familyfactory.createDaddy(),
 * а уж то, что они оба рыжие и 210см. роста, за нас решит фабрика Ч эти параметры мы не задаем.
 *
